...
df.loc["bash_command_line_101", "sets_you_up_for"] = "   bash_command_line_102   bash_103_combining_commands   bash_conditionals_loops   bash_scripts  " 
df.loc["bash_command_line_101", "depends_on_knowledge_in"] = "   git_setup_windows  " 
...
df.loc["bash_command_line_102", "sets_you_up_for"] = "   bash_103_combining_commands   bash_conditionals_loops   bash_scripts  " 
df.loc["bash_command_line_102", "depends_on_knowledge_in"] = "   bash_command_line_101  " 
...
df.loc["bash_conditionals_loops", "depends_on_knowledge_in"] = "   bash_command_line_101   bash_command_line_102  " 
...
df.loc["bash_scripts", "sets_you_up_for"] = "   bash_scripts  " 
df.loc["bash_scripts", "depends_on_knowledge_in"] = "   bash_command_line_101   bash_command_line_102   bash_103_combining_commands  " 
...
df.loc["data_management_basics", "depends_on_knowledge_in"] = "   reproducibility  " 
...
df.loc["data_visualization_in_open_source_software", "sets_you_up_for"] = "   data_visualization_in_ggplot2   data_visualization_in_seaborn  " 
df.loc["data_visualization_in_open_source_software", "depends_on_knowledge_in"] = " " 
...
df.loc["data_visualization_in_seaborn", "depends_on_knowledge_in"] = "   demystifying_python   python_basics_writing_python_code   pandas_transform  " 
...
df.loc["git_creation_and_tracking", "depends_on_knowledge_in"] = "   git_setup_windows   git_setup_mac_and_linux  " 
...
df.loc["git_history_of_project", "depends_on_knowledge_in"] = "   git_setup_windows   git_setup_mac_and_linux   git_creation_and_tracking  " 
...
df.loc["git_setup_windows", "sets_you_up_for"] = "   git_creation_and_tracking   git_history_of_project   bash_command_line_101  " 
...
df.loc["pandas_transform", "sets_you_up_for"] = "   data_visualization_in_seaborn   python_practice  " 
df.loc["pandas_transform", "depends_on_knowledge_in"] = "   demystifying_python   python_basics_writing_python_code  " 
...
df.loc["reproducibility", "sets_you_up_for"] = " " 
df.loc["reproducibility", "depends_on_knowledge_in"] = " " 
...
df.loc["sql_basics", "sets_you_up_for"] = "   sql_intermediate  " 
df.loc["sql_basics", "depends_on_knowledge_in"] = "   demystifying_sql  " 
...
df.loc["sql_intermediate", "depends_on_knowledge_in"] = "   sql_basics  " 
...
df.loc["sql_joins", "depends_on_knowledge_in"] = "   sql_basics   sql_intermediate   database_normalization  " 
...
df.loc["statistical_tests", "depends_on_knowledge_in"] = "   r_basics_introduction   python_basics_writing_python_code  " 
...
df.loc["tidy_data", "sets_you_up_for"] = " " 
df.loc["tidy_data", "depends_on_knowledge_in"] = " " 
