...
remove_all_from_my_modules = dbc.Button("Remove all from my list", color="primary", id="remove_filtered_from_my_modules")
                  ...
                  [dbc.Col(
                    children=[
                     html.Div([
                        ...
                        dbc.Col([add_all_to_my_modules,remove_all_from_my_modules], width=3)
                    ])]),
